...
| 15:30 - 17:15 | Hands-on programming tutorial: DAS client libraries, 10 minute introduction (Leyla)                                              | Leyla Garcia                             | Bio::Das::Lite -or- JAXB (Rafael) -or- JSDAS (Jose & Bernat), Each will cover sources, sequence & features using the same examples   |
