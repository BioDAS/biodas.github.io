...
`A proposal was made and accepted that Gustavo should post a proposal for adding the DAS writeback functionality to DAS under the 1.6E DAS1.6E|DAS/1.6E spec pages of the biodas wiki and give a link to source already developed for this capability.`
